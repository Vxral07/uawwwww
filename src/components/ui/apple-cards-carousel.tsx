  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-96 w-60 md:h-[28rem] hover: md:w-[18rem] overflow-hidden flex flex-col items-start justify-start relative z-10 hover:shadow-[inset_0_0_20px_#0dd3ff] transition-all duration-300 ease-in-out"
      >
        ...
        <div className="relative z-40 p-4">
          ...
          <motion.p
            layoutId={layout ? `title-${card.edition}` : undefined}
            className="text-cyan-400 text-xs md:text-xs font-extralight max-w-xs text-left mt-2"
          >
            Read More
          </motion.p>
        </div>
