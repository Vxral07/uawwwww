    ...
    switch (selectedPage) {
      case "terms":
        return <p>Use of this website is for eligible persons only, which includes Retail Clients, Professional Clients and Market Counterparties as defined in 2. Client classification of the Dubai International Financial Center (“DIFC”) Conduct of Business Rulebook (“Eligible Persons”). <br />
          ...
          <p className="font-semibold text-lg">1.1 Purpose </p>
          ...
          <p className="font-semibold text-lg"> 1.2 Binding Agreement </p>
          ...
          <p className="font-semibold text-lg"> 2. Clients  </p><br/>
          <p className="font-semibold text-lg ">2.1 Eligibility</p> <br/>
          ...
          - THE PERFORMANCE OF OR ACCURACY, QUALITY, CURRENCY, COMPLETENESS, OR USEFULNESS OF ANY INFORMATION PROVIDED BY NUQI ON ITS WEBSITE, INCLUDING BUT NOT LIMITED TO INFORMATION OBTAINED THROUGH SOCIAL MEDIA.<br/>

          No advice or information, whether oral or written, obtained by you from Nuqi's website, shall create any warranty not expressly stated in this Terms of Use. If you choose to rely on such information, you do so solely at your own risk.<br/>
          ...
          <p className="font-semibold text-lg">  3.3 Limitation of Liability </p>
          ...
          <p className="font-semibold text-lg">4. Termination</p>
          ...
          Any suspension, termination, or cancellation shall not affect your obligations to Nuqi under these Terms of Use (including but not limited to ownership, indemnification, and limitation of liability), which by their sense and context are intended to survive such suspension, termination, or cancellation. <br/>

          <p className="font-semibold text-lg">5. Dispute Resolution   </p>
          ...
          Any legal action or proceeding arising under these Terms of Use will be brought exclusively in courts of the DIFC, and the parties hereby irrevocably consent to the personal jurisdiction and venue therein.<br/>

          <p className="font-semibold text-lg"> 6. Nuqi "Dos" and "Don'ts"   </p>

          Nuqi grants you a license to use our website and App so long as you comply with all our rules.

          <p className="font-semibold text-lg">  6.1 Dos.   </p>

          <p className="font-semibold text-lg">You agree you will: </p>
          ...
          <p className="font-semibold text-lg"> 6.2 Don'ts.  </p>

          <p className="font-semibold text-lg">    You agree you won't: </p>
          ...
          Attempt to probe, scan, or test the vulnerability of any Nuqi system or network or breach or impair or circumvent any security or authentication measures protecting Nuqi. <br/>
          Attempt to decipher, decompile, disassemble, or reverse-engineer any of the software used to provide Nuqi.

          Attempt to access, search, or meta-search Nuqi or content thereon with any engine, software, tool, agent, device, or mechanism other than software and/or search agents provided by Nuqi or other generally available third- party web browsers, including without limitation any software that sends queries to Nuqi to determine how a website or web page ranks.<br/>

          Violate the terms of service or any other rule or agreement applicable to you or Nuqi's inclusion in, reference to, or relationship with any third party or third-party site or service, or your use of any such third-party site or service. <br/>

          Collect or store personal information about other users without their express permission.
          Impersonate or misrepresent your affiliation with any person or entity, through pretexting or some other form of social engineering, or commit fraud. <br/>
          ...
          Scrape or copy information through any means (including crawlers, browser plugins and add-ons, 
          ...
          Copy or use the information, content or data on Nuqi in connection with a competitive service (as determined by Nuqi).<br/>
          ...
          If you become aware of any misuse of Nuqi or its content by any person, please contact Nuqi to report the abuse. Nuqi has adopted and implemented a policy that provides for the termination of Accounts of users who infringe the rights of copyright holders.<br/>

          <p className="font-semibold text-lg"> 7. Account Information from Third Party Sites  </p>
          ...
          <p className="font-semibold text-lg">   8. General Terms   </p>
          ...
          <p className="font-semibold text-lg"> 9. International Use </p>
          ...
          <p className="font-semibold text-lg">     10. Miscellaneous      </p><br/>


          <p className="font-semibold text-lg">10.1 Integration & Severability  </p>
          ...
          <p className="font-semibold text-lg"> 10.2 Advice may differ </p>
          ...
          <p className="font-semibold text-lg">10.3 Communication </p>
          ...
          <p className="font-semibold text-lg"> 10.4 Feedback </p>
          ...
          <p className="font-semibold text-lg">10.5 Questions  </p> 
          ...
          <p className="font-semibold text-lg">11. Severance</p>
        ...
        return (
          <>
            ...
            <p className=" font-poppins">
              ...
              <p className="font-bold text-lg "> What information we collect </p> <br />
              ...
              <p className="font-bold text-lg ">Why we collect the information</p> <br />
              ...
              <p className="font-bold text-lg"> Relationship management</p> <br />
              ...
              <p className="font-bold text-lg">Distribution of your information</p> <br />
              ...
              <p className=" text-lg font-bold">Your rights</p> <br />
              The DIFC Data Protection aims to give you more control of your data. It provides new and strengthened rights.<br /><br />
              • Right to access: you can ask us whether we’re processing your personal data, including where and for what purpose. You can also request an electronic copy of your personal data free of charge<br /><br />
              • Right to restrict processing: in certain circumstances, you can ask us to restrict our use of your personal data <br /><br />
              • Right to rectification: you can ask us to correct inaccurate personal data we hold about you<br /><br />
              • Right be forgotten: in certain circumstances, you can ask us to erase your personal data<br /><br />
              • Right to data portability: you can ask us to provide you with a copy of your personal data in a commonly used electronic format, so that you can transfer it to other businesses<br /><br />
              • Right to object to automated decision-making: in certain circumstances, you can ask us not to make automated decisions about you based on your personal data that produce significant legal effects<br /><br />
              • Right to lodge a complaint: you can lodge a complaint with your local data protection authority<br /><br />
              If you would like to exercise any of the above rights, please contact us at compliance@nuqiwealth.me<br /><br />

              <p className=" text-lg font-bold" >Keeping your data safe</p><br />
              ...
              <p className=" text-lg font-bold">Changes to this privacy policy</p><br />
      ...
      case "disclaimer":
        return <p>This disclaimer is intended for general informational purposes only. It is provided by Nuqi Digital Wealth Limited ("NUQI DIFC"), a company regulated by the Dubai Financial Services Authority ("DFSA") with offices located at, 501, Innovation One Building, DIFC, Dubai, UAE.<br /> <br />


          Please note that the information provided is not intended to be research material, investment advice, or a solicitation to buy or sell any securities or financial instruments. It is for general informational purposes only and does not take into account your specific investment objectives, financial situation, or individual needs. You should not rely solely on this information when making investment decisions. Before making any investment, you should carefully review the relevant offering documents and seek independent legal, tax, and regulatory advice. This includes consulting with a qualified advisor to determine if a particular investment is suitable for you, considering your unique circumstances. Opinions, forecasts, and estimates are those of Nuqi Digital Wealth Limited as of the date of this information and are subject to change without notice. Past performance is not indicative of future results, and no guarantee or warranty is made regarding future investment performance. Any forecasts included here regarding potential future movements in rates, prices, events, or occurrences are solely opinions and should not be taken as guarantees of actual future results. Neither the analysts who prepared this information nor their close associates have any material financial interest in the investments mentioned. Additionally, Nuqi Digital Wealth Limited do not hold shares in any of the recommended securities. Furthermore, Nuqi Digital Wealth Limited and its affiliates do not act as corporate brokers, market makers, or have any commercial relationships with the issuers of the securities mentioned in this material. Likewise, none of the issuers of these securities have any ownership stake in Nuqi Digital Wealth Limited or its affiliates.<br /> <br />


          Use of this website is for eligible persons only, which includes Retail Clients, Professional Clients and Market Counterparties as defined in 2. Client classification of the Dubai International Financial Center  (“DIFC”) Conduct of Business Rulebook (“Eligible Persons”). <br />
          ...
          Nuqi has exercised all reasonable care in compiling the information provided on this website. Nevertheless, Nuqi does not guarantee or assert that the information will be promptly updated or that it will reveal all relevant details regarding the services mentioned herein. Additionally, Nuqi does not verify the authenticity of information obtained from third parties..<br />


          No documentation or information provided on this website is intended to constitute a recommendation of any investment, financial advice, or any other advice by any party in any jurisdiction. Full details on the products and services are not available herein and may be provided by Nuqi upon additional request.<br />


          This website contains general information collected, maintained, and provided for the informative purposes and convenience of the eligible user only and shall not be relied upon to make any final business or investment decisions.<br />


          No information contained on this website should be construed as an investment advertisement. Accordingly, nothing in this website is to be construed as providing financial advice, an offer or invitation made to any person to enter into any legal agreement of any kind or exercise any rights whatsoever, in relation to the offering of any security or a solicitation.<br />


          Unauthorized use of the contents of this website is strictly prohibited. Under no circumstances should the information provided on this website be copied, disseminated, reproduced, or redistributed other than printing or downloading for personal non-commercial use by ‘eligible persons’ as defined in the DIFC Conduct of Business Rulebook. No rights of any kind are licensed or assigned or shall otherwise pass to persons accessing this website.<br />
          ...
          By proceeding into this website, you are representing and warranting that you are an Eligible Person as defined in the DIFC Conduct of Business Rulebook and agree to the use of the website subject to the terms and conditions stated herein..<br />
          ...
          We offer traditional External Assets manager and an automated digital investment management service (the Services). Should you choose to become our client (“Client”), we will manage a diversified, continually rebalanced portfolio of securities on your behalf in a very low cost and diversified manner.<br />


          When you use our website and mobile application you enter into a series of legally binding agreements. You also agree to our Privacy Policy which covers how we collect, use, share and store your personal information.<br />
          ...
          For the purpose of this Terms of Use, a User is an individual who uses our website or App to evaluate our Service, or for educational purposes and a Client is an individual who signs our Client Agreement that entitles the Client to have her or his investment portfolio managed by Nuqi on a discretionary basis and in accordance with an agreed investment mandate. This Terms of Use, as well as the Privacy Policy applies to both Users and Clients.<br />


          If you elect to become a Client, you will be subject to these Terms of Use, our Client Agreement, our Privacy Policy and any additional terms to which you agree when you create and fund an investment account.<br /><br/>
          ...
          You will not share your account with anyone else.<br />


          2.2 Your Access<br />


          To access certain features of Nuqi, you must register and create a User Account. During registration, you will choose a password, which you will need to access your User Account. Nuqi employs physical, electronic, and procedural safeguards that comply with DIFC standards to protect Users' and Clients' non-public personal information.<br />


          You are responsible for safeguarding your password and User Account information. You agree not to disclose your password to any third party and to notify Nuqi immediately if your password is lost or stolen or if you suspect any unauthorized use of your User Account. As a User, you agree to be solely responsible for any activities or actions under your User Account, whether or not you have authorized such activities or actions.<br /><br />


          You agree that the information you provide during account registration through our website, app, or any other communication channel will be true, accurate, current, and complete.<br /><br />


          You are prohibited from scraping or copying information through any means (including crawlers, browser plugins, add-ons, and any other technology or manual work) as detailed in Section 6.2.<br />


          The content of the site is protected by applicable copyright and trademark laws. Unauthorized use or exploitation of such content is strictly prohibited, including, but not limited to, unauthorized downloading, retransmission, storage in any medium, copying, redistribution, reproduction, or republication of the site, or any part thereof, for any purpose.<br /><br />
          ...
          2.3 Alerts, Notifications and Service Communications<br />


          By creating a User Account, you automatically sign up for various types of alerts via e-mail and mobile notifications. When logged in, you may customize, modify, and in some cases, deactivate alerts by adjusting the settings accordingly. <br />


          We never include your password in these communications; however, we may include your name, email address, and information about your portfolio(s) if you are a Client. Anyone with access to your email or mobile device will be able to view these alerts.<br />


          3. Disclaimer and Limit of Liability<br /><br />


          Nuqi cannot be held responsible for any financial insights or recommendations provided to Users. This website is only intended to provide you with general information and is neither considered to be a financial advice, an offer to sell nor a solicitation of an offer to purchase any security and may not rely on investment purposes.<br /><br />


          3.1 For a User who is not a Client<br /><br />
          ...
          This is our disclaimer of legal liability.<br /><br />


          3.2 Disclaimer of Warranties<br /><br />
          ...
          These are the limits of legal liability we may have to you.<br />


          3.3 Limitation of Liability<br />


          IN NO EVENT SHALL NUQI OR ANY OF ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU FOR ANY DAMAGES WHATSOEVER, INCLUDING WITHOUT LIMITATION INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF NUQI, CONTENT AND/OR USER INFORMATION, INCLUDING BUT NOT LIMITED TO THE QUALITY, ACCURACY, OR UTILITY OF THE INFORMATION PROVIDED AS PART OF OR THROUGH NUQI OR FOR ANY INVESTMENT DECISIONS MADE ON THE BASIS OF SUCH INFORMATION, WHETHER THE DAMAGES ARE FORESEEABLE AND WHETHER OR NOT NUQI HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW IN THE APPLICABLE JURISDICTION AND IN NO EVENT SHALL NUQI'S CUMULATIVE LIABILITY TO YOU EXCEED U.S. AED250.<br />


          Every effort has been made to ensure that the website's material is accurate at the time of publication. However, Nuqi will not under any circumstances be liable to you or any other person in any way for any loss or damages (direct, indirect, special, economic, incidental, consequential, punitive or exemplary, including without limitation loss of revenue, data, anticipated profits or lost business) in respect of the use of, or inability to use, or any reliance on, the website, any of its content or links (including without limitation any inaccuracies or viruses), or any web browser or other equipment.<br />
          ...
          Each of us can end this Terms of Use at any time.<br />
          ...
          You agree that these Terms of Use shall be governed by and interpreted in accordance with the laws of the DIFC excluding that body of law pertaining to conflict of laws.<br />
          ...
          6. Nuqi "Dos" and "Don'ts"<br />


          Nuqi grants you a license to use our website and App so long as you comply with all our rules.<br />


          6.1 Dos.<br />


          You agree you will:<br />
          ...
          Provide accurate information to us, whether reported directly or through a third party who you authorize, and keep it updated;<br />


          Use the services solely for your personal, non-commercial use;<br />


          Use your real name on your profile and keep your password confidential; and<br />
          ...
          You agree you won't:<br />


          Circumvent, disable, or otherwise interfere with security-related features of Nuqi or features that prevent or restrict use or copying of any content or User information.<br />


          Upload, email, transmit, provide, or otherwise make available:<br />


          any User information which you do not have the lawful right to use, copy, transmit, display, or make available (including any User information that would violate any confidentiality or fiduciary obligations that you might have with respect to the User information); or<br />


          any User information that infringes the intellectual property rights of, or violates the privacy rights of, any third-party (including without limitation copyright, trademark, patent, trade secret, or other intellectual property right, moral right, or right of publicity); or<br />


          unsolicited or unauthorized advertising, promotional materials, junk mail, spam, chain letters, pyramid schemes, or any other form of solicitation; or<br />


          any personal information that is unlawful, obscene, harmful, threatening, harassing, defamatory, or hateful, or that contain objects or symbols of hate, invade the privacy of any third-party, contain nudity, are deceptive, threatening, abusive, inciting of unlawful action, or are otherwise objectionable in the sole discretion of Nuqi; or<br />


          any personal information that contains software viruses or any other computer code, files, or programs designed to (i) interrupt, destroy, or limit the functionality of any computer software; or (ii) interfere with the access of any user, host or network, including without limitation overloading, flooding, spamming, mail-bombing, or sending a virus to Nuqi; or<br />


          any personal information that includes code that is hidden or otherwise surreptitiously contained within the User information.<br />
          ...
          Interfere with or disrupt (or attempt to interfere with or disrupt) any Nuqi web page, server, or network, or the technical delivery systems of Nuqi's providers, or disobey any requirements, procedures, policies, or regulations of networks connected to Nuqi.<br />
          ...
          Collect or store personal information about other users without their express permission.<br />
          ...
          Violate any applicable law and regulation.<br />


          Scrape or copy information through any means (including crawlers, browser plugins and add-ons, and any other technology or manual work).<br />
          ...
          Use Nuqi or content thereon in any manner not permitted by these Terms of Use<br />
          ...
          7. Account Information from Third Party Sites<br /><br />
          ...
          In the event that any provision in these Terms of Use is held to be invalid or unenforceable, the remaining provisions will remain in full force and effect. The failure of a party to enforce any right or provision of these Terms of Use will not be deemed a waiver of such right or provision. You may not assign this Terms of Use (by operation of law or otherwise) without the prior written consent of Nuqi, and any prohibited assignment will be null and void.<br /><br/>


          Nuqi may assign this Terms of Use or any rights hereunder without your consent. The relationship of the parties under these Terms of Use is that of independent contractors, and these Terms of Use will not be construed to imply that either party is the agent, employee, or joint venture of the other. Note that if you elect to become a Client, the relationship of the parties will be governed by these Terms of Use, Client Agreement, our Privacy Policy and any additional terms to which you agree when you create and fund an investment account.<br />


          We may make changes to this Terms of Use and the Service from time to time. We may do this for various reasons, including to reflect changes in or requirements of the applicable law, new features, or changes in business practices.<br />


          The latest version of this Terms of Use will be posted on the website under Terms of Use, and you should regularly check for the latest version. The newest version is the version that applies. If you continue to use the Service after the changes become effective, you agree to the revised Terms of Use. You agree that this Terms of Use shall supersede any prior agreements (except as specifically stated herein) and shall govern your entire relationship with Nuqi, including but not limited to events, agreements, and conduct preceding your acceptance of this Terms of Use. We reserve the right to change this Terms of Use by posting a revised Terms of Use and we agree that changes cannot be retroactive. If you don't agree with these changes, you must stop using Nuqi.<br />


          You agree the only way to provide us legal notice is at the address provided in Section 10.3.<br/>


          9. International Use<br />


          Nuqi does not make any representation that its services are appropriate or available for use outside the DIFC. Similarly, we make no representations that accessing Nuqi from locations outside the DIFC is legal or permissible under local laws. If you access Nuqi from areas outside of the DIFC, you do so at your own risk and are solely responsible for compliance with local laws.


          10. Miscellaneous<br />


          10.1 Integration & Severability<br />
          ...
          Any notice or communication will be in writing by email.<br />


          10.3 Communication<br />
          ...
          Your feedback is welcome and encouraged. You may submit feedback by emailing us at service@nuqiwealth.me . You agree, however, that (i) by submitting unsolicited ideas to Nuqi or any of its employees or representatives, by any medium, including but not limited to email, written, or oral communication, you automatically forfeit your right to any intellectual property rights in such ideas; and (ii) such unsolicited ideas automatically become the property of Nuqi. You hereby assign and agree to assign all rights, title, and interest you have in such feedback and ideas to Nuqi together with all intellectual property rights therein. In addition, you warrant that all moral rights in any feedback have been waived, and you do hereby waive any such moral rights.<br />


          10.5 Questions<br />


          This document constitutes Nuqi's complete Terms of Use for Nuqi and related services.<br />


          If you have questions about these Terms of Use or about Nuqi or content thereon, please contact Nuqi at service@nuqiwealth.me .<br />
